...
apk add mesa mesa-gl mesa-gles mesa-glesv2 mesa-va-gallium mesa-dri-gallium
...
#!/bin/sh
konsole --builtin-profile -e "/home/$TARGET_USER/Desktop/k2-os/etc/kpost.sh" && reboot
EOF
