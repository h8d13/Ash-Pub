...
# Desc: Extended Install AMD / Wayland (+Optionals).
...
apk add mesa-vulkan-radeon mesa-vdpau-radeon libva-utils vulkan-tools
# xf86-video-intel 
...
#rc-update del sddm default (do the same for elogind) 
## Shells
#apk add fish
#chsh -s /bin/zsh root
## Parralel boot 
